"""Backward-compat shim — module moved to ``jyagent.runtime.loop.tracing``.
...
from jyagent.runtime.loop.tracing import *  # noqa: F401,F403
from jyagent.runtime.loop.tracing import __dict__ as _new_dict  # noqa: F401
...
_warnings.warn(
    "jyagent.tracing has moved to jyagent.runtime.loop.tracing; update your imports.",
    DeprecationWarning,
    stacklevel=2,
)
