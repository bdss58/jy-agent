"""Backward-compat shim — module moved to ``jyagent.runtime.loop.checkpoint``.
...
from jyagent.runtime.loop.checkpoint import *  # noqa: F401,F403
from jyagent.runtime.loop.checkpoint import __dict__ as _new_dict  # noqa: F401
...
_warnings.warn(
    "jyagent.checkpoint has moved to jyagent.runtime.loop.checkpoint; update your imports.",
    DeprecationWarning,
    stacklevel=2,
)
