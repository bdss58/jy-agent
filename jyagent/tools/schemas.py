    ...
    # --- manage_memory ---
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "category": {
                    "type": "string",
                    "description": "Category tag. For 'remember' / 'supersede': correction | preference | gotcha | tip | workflow | user_stated | goal. For 'journal': any short tag (default 'note'), e.g. session | debug | ship | research."
                }
            },
            "required": ["action"]
        }
