"""Backward-compat shim — module moved to ``jyagent.runtime.loop.todos``.
...
from jyagent.runtime.loop.todos import *  # noqa: F401,F403
from jyagent.runtime.loop.todos import __dict__ as _new_dict  # noqa: F401
...
_warnings.warn(
    "jyagent.todos has moved to jyagent.runtime.loop.todos; update your imports.",
    DeprecationWarning,
    stacklevel=2,
)
