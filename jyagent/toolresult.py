"""Backward-compat shim — module moved to ``jyagent.runtime.tools.result``.
...
from jyagent.runtime.tools.result import *  # noqa: F401,F403
from jyagent.runtime.tools.result import __dict__ as _new_dict  # noqa: F401
...
_warnings.warn(
    "jyagent.toolresult has moved to jyagent.runtime.tools.result; update your imports.",
    DeprecationWarning,
    stacklevel=2,
)
