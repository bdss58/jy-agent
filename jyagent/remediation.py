"""Backward-compat shim — module moved to ``jyagent.runtime.loop.remediation``.
...
from jyagent.runtime.loop.remediation import *  # noqa: F401,F403
from jyagent.runtime.loop.remediation import __dict__ as _new_dict  # noqa: F401
...
_warnings.warn(
    "jyagent.remediation has moved to jyagent.runtime.loop.remediation; update your imports.",
    DeprecationWarning,
    stacklevel=2,
)
