"""Backward-compat shim — module moved to ``jyagent.runtime.stats``.
...
from jyagent.runtime.stats import *  # noqa: F401,F403
from jyagent.runtime.stats import __dict__ as _new_dict  # noqa: F401
...
_warnings.warn(
    "jyagent.session_stats has moved to jyagent.runtime.stats; update your imports.",
    DeprecationWarning,
    stacklevel=2,
)
