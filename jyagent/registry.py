"""Backward-compat shim — module moved to ``jyagent.runtime.tools.registry``.
...
from jyagent.runtime.tools.registry import *  # noqa: F401,F403
from jyagent.runtime.tools.registry import __dict__ as _new_dict  # noqa: F401
...
_warnings.warn(
    "jyagent.registry has moved to jyagent.runtime.tools.registry; update your imports.",
    DeprecationWarning,
    stacklevel=2,
)
