"""Backward-compat shim — module moved to ``jyagent.runtime.skills``.
...
from jyagent.runtime.skills import *  # noqa: F401,F403
from jyagent.runtime.skills import __dict__ as _new_dict  # noqa: F401
...
_warnings.warn(
    "jyagent.skills has moved to jyagent.runtime.skills; update your imports.",
    DeprecationWarning,
    stacklevel=2,
)
